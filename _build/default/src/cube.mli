...
val from_list : (Facelet.t * color option) list -> t option
val is_solved : t -> bool
val is_well_formed : t -> bool
val equal_cube : t -> t -> bool
val get : t -> Facelet.t -> color option
val set : t -> Facelet.t -> color:(color option) -> (t, string) result
val move : t -> Turn.t -> t
